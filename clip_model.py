...
class ImageSearcher:
    ...
    def find_top(self, similarity, image_paths, top_k):
        """
    ...
    def search(self, description, image_folder, top_k):
        """
        ...
        converted = self.convert_images(top_images)
        print(converted)
        return converted


    def convert_images(self, image_paths, target_size=(300, 300), quality=85):
        """
        Converts a list of image paths to Base64-encoded strings for easy transmission to frontend,
        with resizing and compression to reduce size.
        
        :param image_paths: List of image paths to convert.
        :param target_size: Tuple of the target size for resizing (width, height).
        :param quality: Quality for JPEG compression (1-100).
        ...
        for path in image_paths:
            try:
                ...
                print(f"Error converting {path} to Base64: {e}")
